            ...
            <div className='bg-zinc-800 p-5 w-[40%] h-[60%] flex items-center justify-center rounded-md' >
                <form onSubmit={submitForm} action='' className='w-[80%]'>
                    <div className='mb-3 inputbox border border-zinc-900'>
                        <input onChange={(e)=>{setUsername(e.target.value)}} type='text' placeholder='Username' className='p-2 bg-white'/>
                    </div>
                    <div className='mb-3 inputbox border border-zinc-900'>
                        <input onChange={(e)=>{setName(e.target.value)}} type='text' placeholder='Name' className='p-2'/>
                    </div>
                    <div className='mb-3 inputbox border border-zinc-900'>
                    ...
                    <p className='text-zinc-300 mb-4'>Already Have an account <Link to='/login' className='text-blue-400'>Login</Link></p>
                    <p  className='text-red-500 text[14px] my-2'>{err}</p>
                    <button className="btnBlue w-[100%]">Sign Up</button>
                </form>
            </div>
        </div>
      </div>
